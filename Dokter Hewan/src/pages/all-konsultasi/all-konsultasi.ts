...
@IonicPage()
@Component({
  selector: 'page-all-konsultasi',
  templateUrl: 'all-konsultasi.html',
})
export class AllKonsultasiPage {
idDrh;
idHewan
datam: any;
amb: any; no_reg;
apiURL = "https://healthypets-webservice.appspot.com/_ah/api/ambulator/v1/jsonambulator/";
...
// "https://healthypets-webservice.appspot.com/_ah/api/rekammedik/v1/rekamedik?kode_hewan=";
// "https://20180821t203813-dot-healthypets-webservice.appspot.com/_ah/api/rekammedikDrh/v1/rekamedikdrh?kode_hewan=";
...
rm_drh; namaDrh;
  ...
  getAmbulator(){
    this.http.get(this.apiURL+this.idHewan).subscribe(
      data => {
